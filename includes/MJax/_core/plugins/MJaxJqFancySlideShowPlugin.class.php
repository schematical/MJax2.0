 ...
 */
class MJaxJqFancySlideShowPlugin extends MJaxPluginBase{
    ...
    public function  __construct($objForm, $arrProperties = array()) {
        ...
        $this->objForm->AddHeaderAsset(new MJaxJSHeaderAsset(__VIRTUAL_DIRECTORY__ . __JS_ASSETS__ . '/jqFancyTransitions.1.7.js'));
